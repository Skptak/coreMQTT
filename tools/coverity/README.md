...
compliance of coreMQTT Library using
...
[configuration file](https://github.com/FreeRTOS/coreMQTT/blob/main/tools/coverity/misra.config)
...
[MISRA.md](https://github.com/FreeRTOS/coreMQTT/blob/main/MISRA.md) file.
